...
#include "[shd]\LambertianDiffuseLighting\NormalMappingAndParallax\NM_P_HLDL1.fxh"
				
_DECL_EFFECT_TYPE = RFX_TYPE_HLDL1;
_DECL_EFFECT_DESC = "Hemi Light, 1 Dir Light, Normal Mapping, Parallax, Diffuse";
...
technique t2
{
	pass p0
	{
		VertexShader	=	compile vs_2_0 NM_P_HLDL1VS();
		PixelShader		=	compile ps_2_0 NM_P_HLDL1PS();
	}
};
