...
#ifndef CE_NM_PL1SPEC
#define CE_NM_PL1SPEC

struct VS_OUT_CE_NM_PL1Spec
{
	float4 pos					: POSITION;
...
VS_OUT_CE_NM_PL1Spec
CE_NM_PL1SpecVS( VS_IN_NM input )
{
	VS_OUT_CE_NM_PL1Spec output = (VS_OUT_CE_NM_PL1Spec) 0;
...
PS_OUT_Color
CE_NM_PL1SpecPS( VS_OUT_CE_NM_PL1Spec input )
{
