...
#include "[shd]\LambertianDiffuseLighting\NormalMappingAndParallax\NM_P_PL1.fxh"

_DECL_EFFECT_TYPE = RFX_TYPE_PL1;
_DECL_EFFECT_DESC = "Point Light, Normal Mapping, Parallax, Diffuse";
...
technique t2
{
	...
	{
		DestBlend = ONE;
		VertexShader	=	compile vs_2_0 NM_P_PL1VS();
		PixelShader		=	compile ps_2_0 NM_P_PL1PS();
	}
};
