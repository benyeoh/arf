...
void InitMesh()
{
	...
	*pTriIndices = (ushort) 2;		pTriIndices++;
	...
	IByteBufferPtr pBuffer = g_AppCallback.GetFileData(_W("[shd]\\TestRasterizer\\ScreenTriangle.fx"));
	...
	*pQuadIndices = (ushort) 2;		pQuadIndices++;
	...
	uint semantic = 55;
	pBuffer = g_AppCallback.GetFileData(_W("[shd]\\TestRasterizer\\ScreenTexturedQuad.fx"));
	...
	semantic = 1;
	pBuffer = g_AppCallback.GetFileData(_W("[shd]\\TestRasterizer\\CubeDepth.fx"));
