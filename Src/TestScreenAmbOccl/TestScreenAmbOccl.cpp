...
IRRenderGroupPtr	g_pZPosClearGroup;
IRRenderGroupPtr	g_pNormalsClearGroup;
...
IRTexture2D* g_pZPos = NULL;
IRTexture2D* g_pNormals = NULL;
...
int g_CurAOParamEntry = 0;
IVarParamEntry* g_pAOParamEntries[NUM_AO_PARAM_ENTRIES];

int g_CurTechnique = 0;
IVarParamEntry* g_pTechEntry;

int g_CurDownsampleTechnique = 0;
IVarParamEntry* g_pTechDownsampleEntry;

int g_NumSamples;
gmtl::Vec4f g_AlchemyAOParams;
gmtl::Vec4f g_DistributedSampleParams;
gmtl::Vec4f g_CameraPosWithViewFar;
FarPlaneOffsets g_FarPlaneOffsets;

BFXUScreenSpaceMesh g_AOScreenMesh;
BFXUScreenSpaceMesh g_ZDownsampleMesh[NUM_Z_MIPS];
IRTexture2DPtr g_pAOBuffer;
IRTexture2DPtr g_pNoiseTex;
IREffectPtr g_pAOEffect;
IREffectPtr g_pDownsampleEffect[NUM_Z_MIPS];
IRRenderGroupPtr g_pAOGroup;
IRRenderGroupPtr g_pDownsampleGroups[NUM_Z_MIPS];
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= _W("TestScreenAmbOccl");
	wcex.lpszClassName	= _W("TestScreenAmbOccl");
	wcex.hIconSm		= NULL;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(_W("TestScreenAmbOccl"), _W("TestScreenAmbOccl"), WS_OVERLAPPEDWINDOW,
