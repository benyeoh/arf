...
using ARFManaged.AmbientFXManaged;

namespace MaterialEditorPlugins.AmbientFXUtilMatEd
{
    public class SemanticTable : IPlugin
    {
        ...
        public string Name
        {
            get
            {
                return "AmbientFX Semantic Table";
            }
        }
        ...
        public string Description
        {
            get
            {
                return "Expose parameter semantics for AmbientFX module";
            }
        }
