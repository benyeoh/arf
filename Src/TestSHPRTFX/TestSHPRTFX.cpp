...
IAFXAmbientFXPtr	g_pAmbientFX;
IAFXParamPoolPtr	g_pAFXParamPool;
IPThreadPoolPtr		g_pThreadPool;

BFXUMeshList*	g_pRoomMeshList;
BFXUMeshListPtr	g_pSkyDome;
...
SHPRTCallback	g_SHPRTCallback;
BRDFCallback	g_BRDFCallback;
SHRadianceCallback	g_RadianceCallback;

BFXHemiLight		g_HemiLight;
BFXDirLight			g_DirLight;
BFXPointLight		g_PointLight;
...
AFXAmbientCoeffs	g_AmbientCoeffs;
AFXTransferMatrix	g_AmbientRed;
AFXTransferMatrix	g_AmbientGreen;
AFXTransferMatrix	g_AmbientBlue;
gmtl::VecA3f			g_AmbientZ;
gmtl::VecA3f			g_AmbientY;

float g_TripleProductTable[9 * 9 * 9];
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= _W("TestSHPRTFX");
	wcex.lpszClassName	= _W("TestSHPRTFX");
	wcex.hIconSm		= NULL;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(_W("TestSHPRTFX"), _W("TestSHPRTFX"), WS_OVERLAPPEDWINDOW,
