...
using ARFManaged.SHPRTFXManaged;

namespace MaterialEditorPlugins.SHPRTFXUtilMatEd
{
    public class SemanticTable : IPlugin
    {
        ...
        public string Description
        {
            get
            {
                return "Expose parameter semantics for SHPRTFX module";
            }
        }
