...
#include <MathUtil/gmtl/VecOps.h>
...
//         result.mState = Matrix<DATA_TYPE, ROWS, COLS>::FULL;
    ...
    * @POST: If inversion failed, then error bit is set within the Matrix.
    */
   template <typename DATA_TYPE, unsigned SIZE, bool isAligned, bool isAligned2>
   inline Matrix<DATA_TYPE, SIZE, SIZE, isAligned>& invertFull_orig( Matrix<DATA_TYPE, SIZE, SIZE, isAligned>& result, const Matrix<DATA_TYPE, SIZE, SIZE, isAligned2>& src )
   {
      /*---------------------------------------------------------------------------*
    ...
    */
   template <typename DATA_TYPE, unsigned ROWS, unsigned COLS, bool isAligned, bool isAligned2>
   inline Matrix<DATA_TYPE, ROWS, COLS, isAligned>& invertFull( Matrix<DATA_TYPE, ROWS, COLS, isAligned>& result, const Matrix<DATA_TYPE, ROWS, COLS, isAligned2>& src )
   {
    ...
    */
   template <typename DATA_TYPE, unsigned ROWS, unsigned COLS, bool isAligned, bool isAligned2>
   inline Matrix<DATA_TYPE, ROWS, COLS, isAligned>& invert( Matrix<DATA_TYPE, ROWS, COLS, isAligned>& result, const Matrix<DATA_TYPE, ROWS, COLS, isAligned2>& src )
   {
    ...
    * @POST: If inversion failed, then error bit is set within the Matrix.
    */
   template <typename DATA_TYPE, unsigned ROWS, unsigned COLS, bool isAligned>
   inline Matrix<DATA_TYPE, ROWS, COLS, isAligned>& invert( Matrix<DATA_TYPE, ROWS, COLS, isAligned>& result )
   {
