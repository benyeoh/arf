 ...
 * -----------------------------------------------------------------
 * File:          VecOps.h,v
 * Date modified: 2004/10/30 18:24:33
 * Version:       1.31
 * -----------------------------------------------------------------
 *
 *********************************************************** ggt-head end */
...
#include <MathUtil/gmtl/Math.h>
#include <MathUtil/gmtl/Vec.h>
#ifndef GMTL_NO_METAPROG
#include <MathUtil/gmtl/VecOpsMeta.h>
#include <MathUtil/gmtl/VecExprMeta.h>
#endif
...
#else
template<typename T, unsigned SIZE, typename R1, bool isAligned>
inline VecBase<T,SIZE, meta::VecUnaryExpr<VecBase<T,SIZE,R1,isAligned>, meta::VecNegUnary>,isAligned >
operator-(const VecBase<T,SIZE,R1,isAligned>& v1)
{
   return VecBase<T,SIZE,
                  meta::VecUnaryExpr<VecBase<T,SIZE,R1,isAligned>, meta::VecNegUnary>,isAligned >
                        ( meta::VecUnaryExpr<VecBase<T,SIZE,R1,isAligned>, meta::VecNegUnary>(v1) );
}
#endif
...
#else
template<class DATA_TYPE, unsigned SIZE, typename REP2, bool isAligned>
VecBase<DATA_TYPE, SIZE, meta::DefaultVecTag,isAligned>& operator +=(VecBase<DATA_TYPE, SIZE,meta::DefaultVecTag,isAligned>& v1,
                                      const VecBase<DATA_TYPE, SIZE, REP2,isAligned>& v2)
#endif
{
   for(unsigned i=0;i<SIZE;++i)
   {
...
#else
template<typename T, unsigned SIZE, typename R1, typename R2, bool isAligned>
inline VecBase<T,SIZE, meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>, VecBase<T,SIZE,R2,isAligned>, meta::VecPlusBinary>,isAligned >
operator+(const VecBase<T,SIZE,R1,isAligned>& v1, const VecBase<T,SIZE,R2,isAligned>& v2)
{
   return VecBase<T,SIZE,
               meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                   VecBase<T,SIZE,R2,isAligned>,
                                   meta::VecPlusBinary>,isAligned >( meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                                                               VecBase<T,SIZE,R2,isAligned>,
...
#else
template<typename T, unsigned SIZE, typename R1, typename R2, bool isAligned>
inline VecBase<T,SIZE, meta::VecBinaryExpr<VecBase<T,SIZE,R1, isAligned>, VecBase<T,SIZE,R2, isAligned>, meta::VecMinusBinary>, isAligned>
operator-(const VecBase<T,SIZE,R1,isAligned>& v1, const VecBase<T,SIZE,R2,isAligned>& v2)
{
   return VecBase<T,SIZE,
               meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                   VecBase<T,SIZE,R2,isAligned>,
                                   meta::VecMinusBinary>, isAligned>( meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                                                               VecBase<T,SIZE,R2,isAligned>,
 ...
 */
template<class DATA_TYPE, unsigned SIZE, class SCALAR_TYPE, bool isAligned>
VecBase<DATA_TYPE, SIZE, meta::DefaultVecTag, isAligned>& operator *=(VecBase<DATA_TYPE, SIZE, meta::DefaultVecTag, isAligned>& v1,
...
#else
template<typename T, unsigned SIZE, typename R1, bool isAligned>
inline VecBase<T,SIZE, meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>, VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >, meta::VecMultBinary>, isAligned>
operator*(const VecBase<T,SIZE,R1, isAligned>& v1, const T scalar)
{
   return VecBase<T,SIZE,
             meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                 VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >,
                                 meta::VecMultBinary>,isAligned >(
                                       meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                                           VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >,
...
template<typename T, unsigned SIZE, typename R1, bool isAligned>
inline VecBase<T,SIZE, meta::VecBinaryExpr< VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >,
                                            VecBase<T,SIZE,R1,isAligned>,
                                            meta::VecMultBinary>,isAligned >
operator*(const T scalar, const VecBase<T,SIZE,R1,isAligned>& v1)
{
   return VecBase<T,SIZE,
             meta::VecBinaryExpr<VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >,
                                 VecBase<T,SIZE,R1,isAligned>,
                                 meta::VecMultBinary>,isAligned >(
                                       meta::VecBinaryExpr<VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >,
                                                           VecBase<T,SIZE,R1,isAligned>,
...
#else
template<typename T, unsigned SIZE, typename R1, bool isAligned>
inline VecBase<T,SIZE, meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>, VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >, meta::VecDivBinary>,isAligned >
operator/(const VecBase<T,SIZE,R1,isAligned>& v1, const T scalar)
{
   return VecBase<T,SIZE,
             meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                 VecBase<T,SIZE, meta::ScalarArg<T>,isAligned >,
                                 meta::VecDivBinary>,isAligned >(
                                       meta::VecBinaryExpr<VecBase<T,SIZE,R1,isAligned>,
                                                           VecBase<T,SIZE, meta::ScalarArg<T>,isAligned>,
