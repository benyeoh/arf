...
#include "[shd]\LambertianDiffuseLighting\CubeEnvMapping\NormalMappingAndParallax\CE_NM_P_PL1Spec.fxh"

_DECL_EFFECT_TYPE = RFX_TYPE_PL1;
_DECL_EFFECT_DESC = "1 Point Light, Normal Mapping, Parallax, Diffuse, Specular, Env Mapping";
...
technique t2
{
	...
	{
		DestBlend = ONE;
		VertexShader	=	compile vs_2_0 CE_NM_P_PL1SpecVS();
		PixelShader		=	compile ps_2_0 CE_NM_P_PL1SpecPS();
	}
};