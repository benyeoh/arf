...
using ARFManaged.BaseFXManaged;

namespace MaterialEditorPlugins.BFXUtilMatEd
{
    public class SemanticTable : IPlugin
    {
        ...
        public string Description 
        {
            get
            {
                return "Expose parameter semantics for BaseFX module";
            }
        }
