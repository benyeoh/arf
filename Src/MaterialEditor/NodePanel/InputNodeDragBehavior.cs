...
{
    public class InputNodeDragBehavior : DragBehavior
    {
        ...
        public InputNodeDragBehavior(InputNode input, List<OutputNode> allOutputs)
        {
            m_Input = input;
        ...
        public virtual void BeginDrag(Point pos, float scale)
        {
            ...
            m_OldOutput = m_Input.Binding;
            m_Input.Binding = null;
        }
        ...
        {
            if (m_CurOutput != null)
                m_Input.Binding = m_CurOutput;
            else if (GetScaledRectangle(m_Input.EllipseLabel.Rect, scale).Contains(pos))
                m_Input.Binding = null;
            else
                m_Input.Binding = m_OldOutput;
        }
        ...
        public virtual void Draw(Graphics graphics)
        {
            ...
            graphics.DrawLine(pen, m_Input.EllipseLabel.X, m_Input.EllipseLabel.Y, 
