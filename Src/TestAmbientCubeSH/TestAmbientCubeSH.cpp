...
AFXAmbientCoeffs	g_Coeffs[4];
AFXAmbientCoeffs	g_CurCoeff;
float				g_CurIndex = 0.0f;
float				g_IncRate = 0.0f;

IRTextureCubePtr	g_pRadianceCosineTex[4*3];
float				g_UnitCoeffs[16];
float				g_CosineLobeCoeffs[16];
void*				g_pD3DDevice;
					   ...
					   int       nCmdShow)
{
	...
	CMAllocFns allocFns = GetCoreMemBindings();
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= _W("TestAmbientCubeSH");
	wcex.lpszClassName	= _W("TestAmbientCubeSH");
	wcex.hIconSm		= NULL;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(_W("TestAmbientCubeSH"), _W("TestAmbientCubeSH"), WS_OVERLAPPEDWINDOW,
