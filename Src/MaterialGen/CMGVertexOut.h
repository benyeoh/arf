...
class CMGVertexOut : public CRefCounted<IMGVertexOut>, public IMGShaderNode
{
private: 
...
public: 
	CMGVertexOut(CMGMaterialGen* pGen, const MGParamSig* pParam);
	virtual ~CMGVertexOut();
...
_DECLARE_SMARTPTR(CMGVertexOut)
