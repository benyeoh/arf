...
ISHFXPointLightPtr	g_pShadowPointLight;
ISHFXCubePointLightPtr g_pShadowCubePointLight;
IRTexture2DPtr	g_pCubeDebugRT;
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= _W("TestShadowFX");
	wcex.lpszClassName	= _W("TestShadowFX");
	wcex.hIconSm		= NULL;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(_W("TestShadowFX"), _W("TestShadowFX"), WS_OVERLAPPEDWINDOW,
